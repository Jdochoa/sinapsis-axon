...
function TETrn0.getFAfecta: TFAfecta;
begin
  Result := FFAfecta;
end;

function TETrn0.getLineas: Integer;
begin
  Result := FLineas;
end;

procedure TETrn0.setFAfecta(const Value: TFAfecta);
begin
  FFAfecta := Value;
end;

procedure TETrn0.setLineas(const Value: Integer);
begin
  FLineas := Value;
end;
